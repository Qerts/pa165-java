...
<tag:template title="Edit vehicle">
<jsp:attribute name="body">

<form:form method="post" action="${pageContext.request.contextPath}/vehicle/edit"
           modelAttribute="vehicleEdit" cssClass="form-horizontal">
    <form:hidden path="id" />
